import { ConfigModel, EnvironmentInterface } from '../types/Environment.interface';

import dotenv from 'dotenv';
dotenv.config()

const env = JSON.parse(JSON.stringify(process.env)) as EnvironmentInterface
...
export const config: ConfigModel = {
  ...
  env,
  ssl: {
    keyPath: '../sslCert/server.key',
    crtPath: '../sslCert/server.crt',
  },
  // Base URL
